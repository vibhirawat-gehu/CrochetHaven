...
const SOCIAL_PROVIDERS = [
  ...
  {
    id: 'phone', label: 'Sign up with Phone',
    icon: (
  ...
  {
    id: 'email', label: 'Sign up with Email',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function Register() {
  ...
  const handleSocial = (id) => {
    ...
    setError(`${id.charAt(0).toUpperCase() + id.slice(1)} sign-up is not configured yet.`);
  };
          ...
          <>
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-group">
                ...
                <input name="name" value={form.name} onChange={handleChange} placeholder="Jane Doe" required autoFocus />
              </div>
              <div className="form-group">
